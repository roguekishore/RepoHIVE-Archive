...
import { CommitDistribution as CommitDistributionView } from "@repohive/ui/commits/commit-distribution";
 ...
 * `@repohive/ui/commits` so a second surface cannot end up with its own
